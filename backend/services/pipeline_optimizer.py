            ...
            suggestions.append(
                {
                    ...
                    "rationale": (
                        "Low precision indicates the reranker is letting too "
                        "much noise through to the LLM."
                    ),
                }
            )
            ...
            suggestions.append(
                {
                    ...
                    "rationale": "Low recall suggests initial retrieval is missing relevant chunks.",
                }
            )
            ...
            suggestions.append(
                {
                    ...
                    "rationale": (
                        "Low faithfulness indicates hallucinations; "
                        "stricter prompting or lower temperature can help."
                    ),
                }
            )
            ...
            suggestions.append(
                {
                    ...
                    "rationale": "P95 latency exceeding 3s impacts UX; look into optimizing the chain.",
                }
            )
