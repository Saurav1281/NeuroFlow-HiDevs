...
async def get_pipeline_tools() -> tuple[RetrievalPipeline, NeuroFlowClient]:
...
async def create_query(
    ...
    pending_queries[run_id] = {"query": query, "pipeline_id": pipeline_id}
...
async def stream_query(
    ...
    async def event_generator():
        ...
        gen_iter = generator.generate_stream(
            query, context_data, context_data.get("query_type", "factual"), pipeline_id
        )
